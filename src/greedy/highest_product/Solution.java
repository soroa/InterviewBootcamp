...
public class Solution {
    public int maxp3(ArrayList<Integer> a) {
        ArrayList<Integer> sorted = HeapSort.sort(a);
        return Math.max(sorted.get(0) * sorted.get(1) * sorted.get(2), sorted.get(sorted.size() - 1) * sorted.get(sorted.size() - 2) * sorted.get(0));
    }
